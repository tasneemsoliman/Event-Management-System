...
public class PendingRequests extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SPRequests = new javax.swing.JTable();
        ...
        getContentPane().add(Send, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 80, 130, -1));
        ...
        SPRequests.setBackground(new java.awt.Color(204, 173, 140));
        SPRequests.setFont(new java.awt.Font("Poppins SemiBold", 0, 11)); // NOI18N
        SPRequests.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Customer Name", "Venue", "Event Type", "Duration", "Bill", "Ready Date"
            }
        ) {
        ...
        SPRequests.setToolTipText("");
        SPRequests.setOpaque(false);
        SPRequests.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(SPRequests);
        ...
        jLabel2.setText("Pending Requests from Service Provider");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 490, 40));

        jLabel21.setBackground(new java.awt.Color(204, 173, 140));
        jLabel21.setOpaque(true);
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 140, 10, 100));
        ...
        getContentPane().add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 130, 10, 100));
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        DefaultTableModel model = (DefaultTableModel) SPRequests.getModel();
    ...
    private javax.swing.JTable SPRequests;
